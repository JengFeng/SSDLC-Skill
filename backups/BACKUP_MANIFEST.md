...
| `ssot_template_pre_20260925/`（7 檔） | 2026-09-25 | SSOT 範本補齊前的核心規範、README、YAML、記憶與備份清單本機備份；不納入公開提交 |
| Git commit `2acd65e` | 2026-09-25 | 逆向 Skill 證據交接補強前公開基線，可由 Git 歷史回溯；工作目錄備份僅保留本機 |
