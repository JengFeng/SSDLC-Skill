# 階段規格參照 (spec_ref.md) — 01_planning_and_analysis

> 本檔案定義規劃與需求分析階段執行前必須讀取的 SSOT 規格路徑。
...
| 5 | `../system_specification.md` | 系統功能規格書 SRS |
| 6 | `../phase_gates.json` | 階段關卡管控檔案 |
| 7 | `../00_cross_phase/SKILL.md` | 跨階段全域 Skill 定義 |
