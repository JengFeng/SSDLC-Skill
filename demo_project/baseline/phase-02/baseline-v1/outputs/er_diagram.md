...
| 需求編號 | 對應資料表 | 說明 |
|:---|:---|:---|
| REQ-001 | employees, departments | 員工主檔 CRUD |
| REQ-002 | employee_history | 生命週期管理（Append-Only） |
| REQ-003 | employee_education, employee_experience, employee_certification | 學經歷與證照管理 |
| REQ-005 | employees (role 欄位) | RBAC 角色權限 |
| NFR-002 | employees (_enc 欄位) | 敏感資料加密 |
| NFR-003 | audit_log | 稽核軌跡 |

---

> **SSOT 參照**：`specs/executable_spec.yaml` → `phase_02_design.database.tables`
> **生成工具**：prisma + mermaid
