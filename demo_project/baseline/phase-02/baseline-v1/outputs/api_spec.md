...
| 需求編號 | 對應 API 群組 | 說明 |
|:---|:---|:---|
| REQ-001 | 員工主檔 (CRUD) | 員工新增/查詢/修改/刪除 |
| REQ-002 | 異動歷程 | 員工生命週期管理（Append-Only） |
| REQ-003 | 學經歷/證照 | 多筆學歷/經歷/證照管理 |
| REQ-004 | 個人資料 (ESS) | 員工自助服務 |
| REQ-005 | RBAC 權控 | 三層角色 + 欄位級 ACL |
| REQ-006 | 報表 | 年資/部門/壽星/離職率統計 |
| REQ-007 | 匯出 | Excel .xlsx 匯出 |
| NFR-004 | 認證 | AD SSO + 本機備援 |
| NFR-007 | Session 安全 | 逾時/鎖定機制 |

---

> **SSOT 參照**：`specs/executable_spec.yaml` → `phase_02_design.api.endpoints`
> **生成工具**：openapi_generator
